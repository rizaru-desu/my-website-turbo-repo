...
func (_q *VisitorLogQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *VisitorLogQuery) FirstIDX(ctx context.Context) string {
...
func (_q *VisitorLogQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *VisitorLogQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *VisitorLogQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *VisitorLogQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.VisitorLog.Query().
//		Select(visitorlog.FieldVisitorID).
//		Scan(ctx, &v)
...
func (_q *VisitorLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(visitorlog.Table, visitorlog.Columns, sqlgraph.NewFieldSpec(visitorlog.FieldID, field.TypeString))
	_spec.From = _q.sql
