...
func (_u *SessionUpdate) SetImpersonatedBy(v string) *SessionUpdate {
	_u.mutation.SetImpersonatedBy(v)
	return _u
}

// SetNillableImpersonatedBy sets the "impersonated_by" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableImpersonatedBy(v *string) *SessionUpdate {
	if v != nil {
		_u.SetImpersonatedBy(*v)
	}
	return _u
}

// ClearImpersonatedBy clears the value of the "impersonated_by" field.
func (_u *SessionUpdate) ClearImpersonatedBy() *SessionUpdate {
	_u.mutation.ClearImpersonatedBy()
	return _u
}
...
func (_u *SessionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ImpersonatedBy(); ok {
...
// SetImpersonatedBy sets the "impersonated_by" field.
func (_u *SessionUpdateOne) SetImpersonatedBy(v string) *SessionUpdateOne {
	_u.mutation.SetImpersonatedBy(v)
	return _u
}

// SetNillableImpersonatedBy sets the "impersonated_by" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableImpersonatedBy(v *string) *SessionUpdateOne {
	if v != nil {
		_u.SetImpersonatedBy(*v)
	}
	return _u
...
// ClearImpersonatedBy clears the value of the "impersonated_by" field.
func (_u *SessionUpdateOne) ClearImpersonatedBy() *SessionUpdateOne {
	_u.mutation.ClearImpersonatedBy()
	return _u
}
